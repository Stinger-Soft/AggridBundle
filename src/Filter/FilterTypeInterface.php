...
interface FilterTypeInterface
{
     ...
     * @param array<string, mixed> $columnOptions the configured and resolved options of the column type the filter belongs to.
     * @param array<string, mixed> $gridOptions the configured and resolved options of the grid type the filter belongs to.
     */
     ...
     * @param QueryBuilder|array<string, mixed>|null $dataSource the data source of the underlying grid and column
     ...
     * @param array<string, mixed> $filterTypeOptions an array containing all resolved and configured options of the filter type.
