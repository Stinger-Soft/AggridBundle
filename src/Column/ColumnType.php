...
class ColumnType extends AbstractColumnType
{
    ...
    protected function configureAggridOptions(OptionsResolver $resolver, array $gridOptions = []): void
    {
        ...
        $resolver->setDeprecated('suppressMenu', 'aggrid-bunbdle', '32', 'Use `suppressHeaderMenuButton` instead');

        $resolver->setDefault('suppressHeaderMenuButton', false);
        $resolver->setAllowedTypes('suppressHeaderMenuButton', ['bool']);
    ...
    protected function buildAgGridView(ColumnView $view, ColumnInterface $column, array $options): void
    {
        ...
        $view->vars['suppressHeaderMenuButton'] = $options['suppressHeaderMenuButton'];
    ...
    public function buildJsonConfiguration(ColumnView $view, ColumnInterface $column, array $options): void
    {
        ...
        //todo menuTabs
        $view->jsonConfiguration['suppressHeaderMenuButton'] = $view->vars['suppressHeaderMenuButton'] ?? false;
        ...
        if (isset($view->vars['children']) && count($view->vars['children']) > 0) {
