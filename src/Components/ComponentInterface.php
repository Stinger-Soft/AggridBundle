...
interface ComponentInterface
{
     ...
     *
     * @return array<string, mixed> the options for the component type.
     */
     ...
     *
     * @param array<string, mixed> $componentTypeOptions the options for the component type.
     * @return $this
     */
     ...
     *
     * @return array<string, mixed> the options of the grid the component belongs to
     */
     ...
     *
     * @param array<string, mixed> $gridOptions the options of the grid the component belongs to
     * @return $this
     */
