...
interface GridServiceInterface
{
     ...
     * @param QueryBuilder|array<string, mixed> $dataSource the data source to be used for retrieving grid rows and column values
     * @param array<string, mixed> $options    the options for the grid type
