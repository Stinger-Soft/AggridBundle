...
class DependencyInjectionExtension implements DependencyInjectionExtensionInterface
{
    ...
    /** @var array<string, GridTypeExtensionInterface[]> */
     ...
     * @param array<string, GridTypeExtensionInterface[]>   $gridTypeExtensions
     * @param array<string, ColumnTypeExtensionInterface[]> $columnTypeExtensions
     * @param array<string, FilterTypeExtensionInterface[]> $filterTypeExtensions
     */
    ...
    /**
     * @return FilterTypeExtensionInterface[]
     */
