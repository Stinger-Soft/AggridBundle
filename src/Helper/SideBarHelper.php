...
abstract class SideBarHelper
{
     ...
     */
    public static function getColumnToolPanelConfiguration(
        bool $suppressRowGroups = false,
        bool $suppressValues = false,
        bool $suppressPivots = true,
        bool $suppressPivotMode = true,
        bool $suppressSideButtons = false,
        bool $suppressColumnFilter = false,
        bool $suppressColumnSelectAll = false,
        bool $suppressColumnExpandAll = false
    ): array {
        $toolPanelParams = [
    ...
    /**
     * @param array<string, mixed> $toolPanelParams
     * @return array<string, mixed>
     */
