...
interface ColumnInterface
{
    ...
    /**
     * @return array<int|string, ColumnInterface>
     */
     ...
     *
     * @return QueryBuilder|array<string, mixed> the data source of the column.
     */
     ...
     *
     * @return array<string, mixed> the options of the grid the column belongs to
     */
     ...
     *
     * @param array<string, mixed> $gridOptions the options of the grid the column belongs to
     * @return $this
     */
     ...
     *
     * @return array<string, mixed> the options of the column
     */
     ...
     *
     * @param array<string, mixed> $columnOptions the options of the column
     * @return $this
     */
    ...
    /**
     * Returns whether the column is searchable
     *
     * @return bool true in case the column is searchable, false otherwise
     */
