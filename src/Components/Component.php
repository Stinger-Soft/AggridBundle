...
abstract class Component implements ComponentInterface
{
    ...
    /**
     * @var ArrayCollection<int|string, ComponentInterface> the children of the status bar component (if any)
     */
    protected $children;
     ...
     * @param array<string, mixed> $componentTypeOptions
     ...
     * @param array<string, mixed> $componentOptions          the options defined for the status bar component type type, containing information
