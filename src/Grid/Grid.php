...
class Grid implements GridInterface
{
    ...
    /** @var array<Query\Expr|Query\Expr\Andx|Query\Expr\Orx> */
    protected $searchExpressions = [];

    /** @var array<Query\Expr|Query\Expr\Comparison> */
     ...
     * @param QueryBuilder|array<string, mixed> $dataSource
    ...
    public function __construct(
        ...
        /** @var array<string, array<string, ComponentInterface>> $components */
     ...
     *
     * @return ColumnInterface[] the columns of the table.
     */
    ...
    /**
     * @inheritDoc
     * @return array<string, array<string, ComponentInterface>>|ComponentInterface[]
     */
    ...
    /**
     * @return array<string, mixed>|QueryBuilder|null
     */
    ...
    /**
     * @return array{int, int, array<string, mixed>, string, array<string, mixed>, array<string, mixed>, array<string, mixed>, array<string, mixed>}
     */
     ...
     * @param array<string, mixed> $filter
     * @param array<string, mixed> $groupColumns
     * @param array<string, mixed> $groupColumnKeys
     * @param array<string, mixed> $ids
     */
    ...
    /**
     * @param array<int|string, array<string, mixed>> $grouping
     * @param array<int|string, mixed> $groupPath
     */
     ...
     * @return ColumnInterface|null the column instance for the given columns path
     */
    protected function getColumn(string $columnId): ?ColumnInterface
    {
        foreach ($this->columns as $column) {
     ...
     * @return array<string, mixed> the resolved options for the given grid type.
     * @throws InvalidArgumentTypeException
     * @throws ReflectionException
     */
    ...
    protected function orderGroupColumn(ColumnInterface $column): void
    {
     ...
     * </code>
     *
     * @param array<string, mixed> $orderByEntries
