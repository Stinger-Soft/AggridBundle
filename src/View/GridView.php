...
{
    /**
     * @var array<string, mixed> the options for the grid type, containing information such as the translation_domain etc.
     */
    ...
    /**
     * @var ColumnInterface[] the columns belonging to the grid
     */
    protected $columns;
    ...
    /**
     * @var array<string, array<string, ComponentView>>
     */
     ...
     * @param array<string, mixed> $gridOptions                  the options for the grid type, containing information such as the
     *                                                           translation_domain etc.
     * @param ColumnInterface[]    $columns                      the columns belonging to the grid, required for generating the column
     *                                                           views
     * @param array<string, array<string, ComponentInterface>> $components the status bar components belonging to the grid,
     ...
     *
     * @return array<string, array<string, ComponentView>> an array containing the views for all the status bar components belonging to the grid
     */
