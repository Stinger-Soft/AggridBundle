...
class Filter implements FilterInterface
{
    ...
    /**
     *
     * @var array<string, mixed> the options defined for the filter type.
     */
    protected $filterOptions;

    /**
     *
     * @var array<string, mixed> the options defined for the original column this filter belongs to
     */
    protected $columnOptions;

    /**
     * @var array<string, mixed> the view options of the column this filter belongs to
     */
    protected $columnViewVars;

    /**
     *
     * @var array<string, mixed> the options defined for the original table this filter belongs to
     */
    protected $gridOptions;

    /**
     *
     * @var FilterInterface|null the parent filter (if any)
     */
    protected $parent;
    ...
    /**
     *
     * @var QueryBuilder|null the query builder of the table the column and this the filter will be attached to
     */
    protected $queryBuilder;

    /**
     * @var  QueryBuilder|array<string, mixed>|null
     */
     ...
     * @param array<string, mixed> $filterTypeOptions
     ...
     * @param QueryBuilder|array<string, mixed>|null $dataSource
    ...
    {
        if (null === $parent && $this->parent) {
            $this->parent->createJsonConfiguration($filterView);
        }
    ...
    protected function buildView(FilterView $filterView, FilterTypeInterface $filterType, array $filterOptions = [], array $extensions = []): void
    {
        ...
        } elseif ($this->columnOptions['query_path'] !== null) {
     ...
     * @return array<string, mixed> the resolved options for the given filter type.
     * @throws InvalidArgumentTypeException
     * @throws ReflectionException
     */
