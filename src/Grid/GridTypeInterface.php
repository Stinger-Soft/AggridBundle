...
interface GridTypeInterface
{
     ...
     * @param array<string, mixed> $gridOptions the options of the grid, previously configured via the #configureOptions method
     * @param ColumnInterface[]      $columns     the columns of the grid
     * @return void
     */
     ...
     *
     * @param array<string, mixed> $gridOptions the resolved options of the grid type, maybe containing an id prefix or suffix
