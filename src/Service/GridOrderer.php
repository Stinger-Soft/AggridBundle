...
class GridOrderer implements GridOrdererInterface
{
    ...
    /** @var array<string, array<string, array<int, ColumnInterface>>> */
    protected $differed;
     ...
     *
     * @param ColumnInterface $column   The column.
     * @param array<string, mixed> $position The position.
     */
     ...
     * @param string $position The position (before|after)
     * @param array<string, mixed> $stack    The circular stack.
     *
