...
interface FilterInterface
{
    ...
    /**
     * Creates the json configuration for the filter view.
     *
     * @param FilterView      $filterView the filter view to add json configuration to
     * @param FilterView|null $parent     the parent view (if any)
     */
     ...
     *
     * @return array<string, mixed> the options defined for the filter type.
     */
     ...
     *
     * @param array<string, mixed> $filterOptions the options defined for the filter type.
     ...
     *
     * @return array<string, mixed> the options defined for the original column this filter belongs to
     */
     ...
     *
     * @param array<string, mixed> $columnOptions the options defined for the original column this filter belongs to
     * @return FilterInterface
     */
