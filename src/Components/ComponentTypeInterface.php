...
interface ComponentTypeInterface
{
     ...
     * @param array<string, mixed> $gridOptions  the options of the grid the component belongs to, containing options such as
     ...
     * @param array<string, mixed> $options   the options of the component, previously configured by the #configureOptions method
     * @return void
     */
