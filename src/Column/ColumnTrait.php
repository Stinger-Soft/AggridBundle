...
{
    /**
     * @var PropertyAccessor|null Helper to access properties by its path
     */
     ...
     * @param Options|array<string, mixed>|null $options any additional options which may be required
     ...
     * @param array<string, mixed> $options    the options to get the option value from and to be passed to the delegate if necessary
