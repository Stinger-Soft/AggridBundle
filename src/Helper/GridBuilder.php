...
/**
 * @implements IteratorAggregate<string, ColumnInterface>
 */
class GridBuilder implements IteratorAggregate, GridBuilderInterface
{
    ...
    /**
     * @var array<string, array<string, ComponentInterface>> Array of all status bar components
     */
    ...
    /**
     * @var array<string, mixed> the options for the grid
     */
    ...
    /**
     * @return array<string, ComponentInterface>|array<string, array<string, ComponentInterface>>
     */
