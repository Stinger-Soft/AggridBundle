...
class Column implements ColumnInterface
{
    ...
    /**
     * @var string|null the path to be used by a query builder for sorting and ordering etc. This may differ from the
    ...
    /**
     * @var array<string, mixed> the options defined for the column type.
     */
    ...
    /**
     * @var array<string, mixed> the options defined for the original table this column belongs to
     */
    ...
    /**
     * @var string|null the path to be used for querying the potential filter values for select or autocomplete filters
     */
    ...
    /**
     * @var ArrayCollection<int|string, ColumnInterface> the children of the column (if any)
     */
    protected $children;
    ...
    /**
     * @var array<string, mixed>|QueryBuilder|null
     */
    ...
    /**
     * @var Filter|null the filter object, resolved from filter type option and filter options option.
     ...
     * @param array<string, mixed>                  $columnTypeOptions the options for the column type
     * @param array<string, mixed>                  $gridOption        the options of the table the column belongs to
     * @param QueryBuilder|array<string, mixed>|null $dataSource       the data source of the table the column will be attached to. In case it is a query builder, it will be cloned in order to
    ...
    public function applyChildrenOrder(array $keys): void
    {
        ...
        /** @var ArrayCollection<int|string, ColumnInterface> $newChildren */
     ...
     *
     * @return QueryBuilder|array<string, mixed>|null the data source of the column.
     */
     ...
     * @param array<string, mixed>  $columnOptions the options of the column type
     * @param array<string, mixed>  $gridOptions   the options of the table type the column belongs to
     ...
     * @param array<string, mixed> $options    the initial options to also be resolved (if any).
     * @return array<string, mixed> the resolved options for the given column type.
     * @throws InvalidArgumentTypeException
     * @throws ReflectionException
     */
     ...
     * @param array<string, mixed> $columnOptions the options defined for the column type, containing information
     ...
     * @param array<string, mixed> $options    the options for the column type.
